// Inline stroke icons for the dashboard. Kept as small components so no icon
// dependency (and no external font/CDN) is pulled in. All inherit currentColor.
...
export const IconVenus = (p) => (
    <svg {...base} {...p}><circle cx="12" cy="9" r="6" /><line x1="12" y1="15" x2="12" y2="22" /><line x1="9" y1="19" x2="15" y2="19" /></svg>
);
...
export const IconTrash = (p) => (
    <svg {...base} {...p}><polyline points="3 6 5 6 21 6" /><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6" /><path d="M10 11v6M14 11v6" /><path d="M9 6V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2" /></svg>
);
