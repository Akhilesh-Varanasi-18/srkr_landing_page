...
// '2028' (3rd year) temporarily removed — 3rd years are not registering right now.
// Add '2028' back here (and re-enable its form option) to allow 3rd-year registrations.
export const PASSOUT_YEARS = ['2030', '2029'];
...
export function validateRegistration(raw = {}) {
    const values = {
        ...
        // paidCrtFee is a 3rd-year-only field, currently disabled in the form:
    ...
    // CRT training fee is a 3rd-year-only field, currently disabled in the form.
    // Re-enable this block (and the value above) when 3rd years can register again.
