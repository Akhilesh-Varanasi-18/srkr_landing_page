...
// Passout years whose registrations are CLOSED. The form shows these as a disabled
// option with a notice, and the API rejects any submission for them. Add/remove
// years here to close/reopen a batch (e.g. '2029' = 2nd Year / SkillUp Coder).
// REOPENED per management — SkillUp Coder (2029) registrations are running again.
// To close 2029 again, restore: export const CLOSED_PASSOUT_YEARS = ['2029'];
export const CLOSED_PASSOUT_YEARS = [/* '2029' */];
